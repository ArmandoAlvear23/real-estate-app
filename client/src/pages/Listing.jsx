            ...
            <div>
                ...
                <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
                    ...
                    <div className="flex gap-4">
                        <p className="bg-red-800 max-w-[200px] w-full text-white text-center p-1 rounded-md">
                            {listing.type === "rent" ? "For Rent" : "For Sale"}
                        </p>
                        {listing.offer && (
                            <p className="bg-green-800 max-w-[200px] w-full text-white text-center p-1 rounded-md">
